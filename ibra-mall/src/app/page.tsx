    ...
    <main className="w-full">
      ...
      <div className="p-5">
        ...
        <section className="bg-pink-50">
         <div className=" p-5"> <h2 className="text-center p-5 font-bold text-[20px]">
            Smartphones and Accessories
          </h2> </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 bg-pink-200  gap-5">
            ...
            <div className="grid border-2 border-pink-500 p-5">
        ...
        <section className="bg-pink-50">
          <h2 className="text-center p-5 font-bold text-[20px]">Fashion Apparel</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 bg-pink-200  gap-5">
          <div className="grid border-2 border-pink-500 p-5">
